...
<div class="flex h-[calc(100vh-64px)] overflow-hidden bg-slate-50">
    ...
    <aside class="hidden lg:flex w-72 flex-col border-r border-slate-200 bg-white h-full shrink-0">
        <nav class="flex-1 px-6 py-8 space-y-2">
            ...
            <a href="#" class="sidebar-link flex items-center gap-4 px-4 py-3 text-slate-500 hover:text-primary hover:bg-slate-50 rounded-xl text-sm font-bold transition-all">
    ...
    <main class="flex-1 flex flex-col overflow-y-auto px-6 lg:px-12 py-10 max-w-7xl mx-auto w-full">
        ...
        <div class="flex flex-wrap justify-between items-end gap-6 mb-10">
            ...
            <button class="flex items-center gap-3 px-6 h-12 bg-white border border-slate-100 rounded-xl text-sm font-black shadow-sm hover:bg-slate-50 transition-all">
        ...
        <section class="mb-12">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-8">
                ...
                <div class="flex p-1.5 bg-slate-100 rounded-xl">
                    <button class="px-5 py-2 rounded-lg text-xs font-black bg-white shadow-sm">All</button>
                    <button class="px-5 py-2 rounded-lg text-xs font-black text-slate-500 flex items-center gap-2 hover:text-primary transition-colors">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group cursor-pointer">
                    <div class="aspect-video w-full rounded-2xl relative overflow-hidden mb-4 shadow-lg group-hover:shadow-primary/10 transition-all">
                        <img src="{{ asset('storage/'.$course->thumbnail) }}" onerror="this.src='https://placehold.co/600x400?text=Course'" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-xs font-black text-slate-400 flex items-center gap-1 uppercase tracking-widest">
                            <span class="material-symbols-outlined text-base">videocam</span> Course
                        </span>
                    </div>
                </div>
                @empty
