...
<div style="min-height: 80vh; display: flex; align-items: center; justify-content: center; padding: 1rem;">
    <div style="background: white; padding: 2.5rem; border-radius: 1rem; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1); width: 100%; max-width: 400px;">
        <div style="text-align: center; margin-bottom: 2rem;">
            <h2 style="font-size: 1.875rem; font-weight: 700; color: #1e293b; letter-spacing: -0.025em;">Welcome Back</h2>
            <p style="color: #64748b; margin-top: 0.5rem;">Sign in to continue to DBIM</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div style="margin-bottom: 1.5rem;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                    <label for="password" style="font-size: 0.875rem; font-weight: 500; color: #475569;">Password</label>
                    <a href="{{ route('password.request') }}" style="font-size: 0.875rem; color: var(--primary-color); font-weight: 500;">Forgot password?</a>
                </div>
        ...
        <p style="text-align: center; margin-top: 2rem; color: #64748b; font-size: 0.875rem;">
            ...
            <a href="{{ route('register') }}" style="color: var(--primary-color); font-weight: 500;">Create account</a>
        </p>
    </div>
</div>
@endsection
